...
class Hybrid_Crossover_MM(SignalBase):
    def __init__(self, accnt=None, win_short=12, win_med=26, win_long=50):
        super(Hybrid_Crossover_MM, self).__init__(accnt)
        ...
        self.obv = OBV()
        self.ema12 = EMA(self.win_short)
        self.ema26 = EMA(self.win_med, lag_window=5)
        self.ema50 = EMA(self.win_long, lag_window=5)
        self.ema100 = EMA(100, lag_window=5)
        self.detector = PeakValleyDetect()
        self.ema200 = EMA(200, lag_window=5)
        self.obv_ema12 = EMA(self.win_short)
