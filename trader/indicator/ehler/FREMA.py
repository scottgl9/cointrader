...
class FREMA(object):
    ...
    def update(self, close):
        ...
        self.RE2.add(np.exp(2 * np.log(CC)) * self.RE1[0] + self.RE1[1])
        self.RE3.add(np.exp(4 * np.log(CC)) * self.RE2[0] + self.RE2[1])
        self.RE4.add(np.exp(8 * np.log(CC)) * self.RE3[0] + self.RE3[1])
        self.RE5.add(np.exp(16 * np.log(CC)) * self.RE4[0] + self.RE4[1])
        self.RE6.add(np.exp(32 * np.log(CC)) * self.RE5[0] + self.RE5[1])
        self.RE7.add(np.exp(64 * np.log(CC)) * self.RE6[0] + self.RE6[1])
        self.RE8.add(np.exp(128 * np.log(CC)) * self.RE7[0] + self.RE7[1])
