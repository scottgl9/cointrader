...
class TrueCrossover(object):
    def __init__(self, pre_win_secs=0, win_secs=60, max_win_size=90):
        self.win_secs = win_secs
        self.pre_win_secs = pre_win_secs
        self.max_win_size = max_win_size

        self.values1 = [None] * self.max_win_size
        self.values2 = [None] * self.max_win_size
        self.timestamps = [None] * self.max_win_size
        self.pre_values1 = [None] * self.max_win_size
        self.pre_values2 = [None] * self.max_win_size
        self.pre_timestamps = [None] * self.max_win_size
        self.pre_age = 0
        self.age = 0
        self.last_age = 0
