...
def simulate(hkdb, symbol, start_ts, end_ts):
    ...
    hourly_24hr_quote_volumes = []
    hourly_24hr_base_volumes = []
    hourly_24hr_x_values = []
    ...
    for msg in msgs: #get_rows_as_msgs(c):
        ...
        hourly_24hr_stats.hourly_update(ts)
        if hourly_24hr_stats.ready():
            hourly_24hr_base_volumes.append(hourly_24hr_stats.get_base_volume_24hr())
            hourly_24hr_quote_volumes.append(hourly_24hr_stats.get_quote_volume_24hr())
            hourly_24hr_x_values.append(i)
    ...
    plt.subplot(212)
    #plt.plot(hourly_24hr_x_values, hourly_24hr_base_volumes)
    plt.plot(hourly_24hr_x_values, hourly_24hr_quote_volumes)
    plt.show()
