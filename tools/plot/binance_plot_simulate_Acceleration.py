...
def simulate(conn, client, base, currency):
    ...
    obv = OBV()
    accelema12 = Acceleration(percent=False)
    accelema26 = Acceleration(percent=False)
    accelema200 = Acceleration(percent=False)
    vema12 = Velocity(percent=False)
    vema26 = Velocity(percent=False)
    vema200 = Velocity(percent=False)
