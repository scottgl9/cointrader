...
def simulate(conn, client, logger):
    ...
    multitrader = MultiTrader(client, 'macd_signal_stop_loss_strategy', assets_info=assets_info, volumes=None, simulate=True, accnt=accnt, ranking=False, logger=logger)
