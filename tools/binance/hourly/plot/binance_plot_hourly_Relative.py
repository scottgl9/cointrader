...
def simulate(kdb, symbol, start_ts, end_ts):
    min_quote = kdb.get_min_field_value(symbol, 'quote_volume', start_ts, end_ts)
    max_quote = kdb.get_max_field_value(symbol, 'quote_volume', start_ts, end_ts)
    min_close =  kdb.get_min_field_value(symbol, 'close', start_ts, end_ts)
    max_close = kdb.get_max_field_value(symbol, 'close', start_ts, end_ts)
